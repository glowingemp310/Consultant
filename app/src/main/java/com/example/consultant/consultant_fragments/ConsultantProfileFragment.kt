 ...
 * Use the [ConsultantProfileFragment.newInstance] factory method to
...
class ConsultantProfileFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment ConsultantProfileFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            ConsultantProfileFragment().apply {
