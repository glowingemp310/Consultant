...
class AdapterHomeConsulteeBottom(var showData: MutableList<ModelHomeConsulteeBottom>):RecyclerView.Adapter<AdapterHomeConsulteeBottom.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: AdapterHomeConsulteeBottom.ViewHolder, position: Int) {
        ...
        holder.binding.tvTitle.text=categories.title
